...
func setContextValueForRequest(r *http.Request, key interface{}, value interface{}) {
	ctx := contextForRequest(r)
	ctx = context.WithValue(ctx, key, value)

	contextLock.Lock()
	defer contextLock.Unlock()
	contexts[r].context = ctx
}

func getContextValueForRequest(r *http.Request, key interface{}) interface{} {
	ctx := contextForRequest(r)
...
func (h validationHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		setContextValueForRequest(r, nameKey, request.Name)
...
func (h helloWorldHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	name := getContextValueForRequest(r, nameKey).(string)
